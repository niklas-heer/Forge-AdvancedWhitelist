...
public class AnvilChunkLoader implements IChunkLoader, IThreadedFileIO {
   ...
   private Chunk func_75823_a(World p_75823_1_, NBTTagCompound p_75823_2_) {
      ...
      NBTTagList var16 = p_75823_2_.func_74761_m("Entities");
      if(var16 != null) {
         for(int var15 = 0; var15 < var16.func_74745_c(); ++var15) {
            NBTTagCompound var17 = (NBTTagCompound)var16.func_74743_b(var15);
            Entity var22 = EntityList.func_75615_a(var17, p_75823_1_);
      ...
      if(var19 != null) {
         for(int var18 = 0; var18 < var19.func_74745_c(); ++var18) {
            NBTTagCompound var20 = (NBTTagCompound)var19.func_74743_b(var18);
            TileEntity var14 = TileEntity.func_70317_c(var20);
            if(var14 != null) {
      ...
      if(p_75823_2_.func_74764_b("TileTicks")) {
         ...
         if(var23 != null) {
            for(int var21 = 0; var21 < var23.func_74745_c(); ++var21) {
               NBTTagCompound var24 = (NBTTagCompound)var23.func_74743_b(var21);
